...
CREATE TABLE IF NOT EXISTS `nhn_academy_29`.`Products` (
  ...
  `ProductThumbnail` VARCHAR(100) NULL DEFAULT NULL,
  `ProductImage` VARCHAR(100) NULL DEFAULT NULL,
  `UnitCost` DECIMAL(15,0) NULL DEFAULT NULL,
  `UnitQuantity` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `nhn_academy_29`.`Categories` (
  ...
  INDEX `fk_Categories_Product_idx` (`ProductID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `nhn_academy_29`.`OrderDetails` (
  ...
  INDEX `fk_OrderDetails_Product_idx` (`ProductID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `nhn_academy_29`.`userpointDetail` (
  `userpointDetailID` VARCHAR(45) NOT NULL,
  `userID` VARCHAR(50) NULL DEFAULT NULL,
  `userpointchange` VARCHAR(100) NULL DEFAULT NULL,
  `userpointchangeamount` DECIMAL(15,0) NULL DEFAULT NULL,
  `userpointchangedate` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`userpointDetailID`),
  UNIQUE INDEX `userpointID_UNIQUE` (`userpointDetailID` ASC) VISIBLE,
