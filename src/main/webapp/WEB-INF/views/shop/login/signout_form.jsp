...
<div style="margin: auto; width: 400px;">
    <div class="p-2">
        <form method="post" action="/signoutAction.do">
            <c:choose>
                <c:when test="${not empty requestScope.wrongUserInput}">
                    <h1 class="h3 mb-3 fw-normal" style="color: red">정보를 정확히 입력해 주세요</h1>
                </c:when>

                <c:otherwise>
                    <h1 class="h3 mb-3 fw-normal">안녕히 가세요</h1>
                </c:otherwise>
            </c:choose>
